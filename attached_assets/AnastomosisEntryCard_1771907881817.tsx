...
export function AnastomosisEntryCard({
  ...
  return (
    ...
    >
      ...
      {/* Arteries are almost always hand-sewn but technically can use coupler */}
      {entry.vesselType === "artery" ? (
      ...
      {/* Configuration — applies to both arteries AND veins.
          End-to-side is common for veins (e.g. IJV in H&N), not just arteries. */}
      <PickerField
        label="Configuration"
