...
export function ProcedureSubcategoryPicker({
  ...
  // Auto-select first subcategory that contains the current selection,
  // or just the first subcategory if nothing selected yet.
  const initialSubcat = () => {
    if (selectedEntryId) {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Procedure list for active subcategory */}
