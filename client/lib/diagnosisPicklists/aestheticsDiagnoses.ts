...
const AES_DX_FACIAL_AGEING: DiagnosisPicklistEntry[] = [
  ...
  },
  {
    ...
    snomedCtCode: "246815009",
    snomedCtDisplay: "Excess skin of eyelid (finding)",
    specialty: "aesthetics",
    subcategory: "Facial Ageing",
    clinicalGroup: "elective",
    intent: "cosmetic",
  ...
  },
  {
    ...
    snomedCtCode: "246813002",
    snomedCtDisplay: "Ptosis of eyebrow (finding)",
    specialty: "aesthetics",
    subcategory: "Facial Ageing",
    clinicalGroup: "elective",
    intent: "cosmetic",
...
const AES_DX_NOSE_EAR: DiagnosisPicklistEntry[] = [
  ...
  },
  {
    ...
    snomedCtCode: "232220000",
    snomedCtDisplay: "Split earlobe (disorder)",
    specialty: "aesthetics",
    subcategory: "Nose & Ear",
    clinicalGroup: "elective",
    intent: "cosmetic",
...
const AES_DX_SKIN_VOLUME: DiagnosisPicklistEntry[] = [
  {
    ...
    snomedCtCode: "247434009",
    snomedCtDisplay: "Wrinkled skin (finding)",
    specialty: "aesthetics",
  ...
  },
  {
    ...
    snomedCtCode: "43982006",
    snomedCtDisplay: "Solar degeneration (disorder)",
    specialty: "aesthetics",
    subcategory: "Skin & Volume",
    clinicalGroup: "elective",
    intent: "cosmetic",
...
const AES_DX_BODY: DiagnosisPicklistEntry[] = [
  ...
  },
  {
    ...
    snomedCtCode: "341000119102",
    snomedCtDisplay: "Tattoo of skin (finding)",
    specialty: "aesthetics",
    subcategory: "Body Aesthetics",
    clinicalGroup: "elective",
    intent: "cosmetic",
...
const AES_DX_LIPODYSTROPHY: DiagnosisPicklistEntry[] = [
  {
    ...
    snomedCtCode: "788978004",
    snomedCtDisplay: "Localised lipodystrophy (disorder)",
    specialty: "aesthetics",
