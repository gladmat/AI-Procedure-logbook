 ...
 * SNOMED CT codes marked `// VERIFY` need Ontoserver validation (Phase 7).
 */
...
const LYMPH_DX_SECONDARY_CANCER: DiagnosisPicklistEntry[] = [
  ...
  },
  {
    ...
    snomedCtCode: "443250000", // VERIFY
    snomedCtDisplay: "Lymphedema of trunk (disorder)",
    specialty: "lymphoedema",
    subcategory: "Secondary — Post-Cancer",
    clinicalGroup: "secondary_cancer",
    hasStaging: true,
  ...
  },
  {
    ...
    snomedCtCode: "445710004",
    snomedCtDisplay: "Lymphedema following surgical procedure (disorder)",
    specialty: "lymphoedema",
    subcategory: "Secondary — Post-Cancer",
    clinicalGroup: "secondary_cancer",
    hasStaging: true,
  ...
  },
  {
    ...
    snomedCtCode: "403462001", // VERIFY
    snomedCtDisplay: "Genital lymphedema (disorder)",
    specialty: "lymphoedema",
    subcategory: "Secondary — Post-Cancer",
    clinicalGroup: "secondary_cancer",
    hasStaging: true,
...
const LYMPH_DX_PRIMARY: DiagnosisPicklistEntry[] = [
  {
    ...
    shortName: "Milroy",
    snomedCtCode: "32914008",
    snomedCtDisplay: "Milroy disease (disorder)",
    specialty: "lymphoedema",
  ...
  },
  {
    ...
    snomedCtCode: "439128001",
    snomedCtDisplay: "Hereditary lymphedema (disorder)",
    specialty: "lymphoedema",
    subcategory: "Primary Lymphoedema",
    clinicalGroup: "primary",
    hasStaging: true,
  ...
  },
  {
    ...
    snomedCtCode: "95570007",
    snomedCtDisplay: "Primary lymphedema (disorder)",
    specialty: "lymphoedema",
    subcategory: "Primary Lymphoedema",
    clinicalGroup: "primary",
    hasStaging: true,
...
const LYMPH_DX_LIPEDEMA: DiagnosisPicklistEntry[] = [
  {
    ...
    shortName: "Lipedema",
    snomedCtCode: "33129002",
    snomedCtDisplay: "Lipedema (disorder)",
    specialty: "lymphoedema",
...
const LYMPH_DX_MALFORMATION: DiagnosisPicklistEntry[] = [
  {
    ...
    snomedCtDisplay: "Lymphangioma (disorder)",
    specialty: "lymphoedema",
  ...
  },
  {
    ...
    snomedCtCode: "234097001", // VERIFY
    snomedCtDisplay: "Lymphatic fistula (disorder)",
    specialty: "lymphoedema",
    subcategory: "Malformation & Chylous",
    clinicalGroup: "chylous",
    hasStaging: false,
...
const LYMPH_DX_EXPERIMENTAL: DiagnosisPicklistEntry[] = [
  {
    ...
    snomedCtCode: "26929004", // VERIFY
    snomedCtDisplay: "Alzheimer's disease (disorder)",
    specialty: "lymphoedema",
