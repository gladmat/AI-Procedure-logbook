    ...
    stagingSystems: [
      {
        ...
        options: [
          { value: "in_situ", label: "In situ (0mm)", description: "Confined to epidermis — MIS" },
          { value: "≤0.8", label: "≤0.8 mm", description: "T1 — SLNB not routine" },
          { value: "0.81-1.0", label: "0.81–1.0 mm", description: "T1 — SLNB should be offered (≥0.8mm)" },
          { value: "1.01-2.0", label: "1.01–2.0 mm", description: "T2 — intermediate thickness" },
          { value: "2.01-4.0", label: "2.01–4.0 mm", description: "T3 — thick melanoma" },
          { value: ">4.0", label: ">4.0 mm", description: "T4 — very thick melanoma" },
        ],
      },
      {
        name: "Ulceration",
        ...
        options: [
          { value: "absent", label: "Absent", description: "No ulceration — substage 'a'" },
          { value: "present", label: "Present", description: "Ulceration present — substage 'b'" },
        ],
      },
      {
        name: "Clark Level",
        description: "Anatomical level of invasion (optional — less used in AJCC 8th)",
        options: [
          { value: "I", label: "Level I", description: "Epidermis only (in situ)" },
          { value: "II", label: "Level II", description: "Papillary dermis" },
          { value: "III", label: "Level III", description: "Filling papillary dermis" },
      ...
      },
      {
        ...
        options: [
          ...
          { value: "positive_micro", label: "N+ micrometastases", description: "Detected by SLNB" },
          { value: "positive_macro", label: "N+ macrometastases", description: "Clinically detected" },
        ],
      },
    ],
  },
    ...
    stagingSystems: [
      {
        ...
        options: [
          { value: "nodular", label: "Nodular", description: "Most common, low risk" },
          { value: "superficial", label: "Superficial", description: "Low risk" },
          { value: "morphoeic", label: "Morphoeic (sclerosing)", description: "HIGH RISK — aggressive subtype" },
          { value: "infiltrative", label: "Infiltrative", description: "HIGH RISK — aggressive subtype" },
          { value: "micronodular", label: "Micronodular", description: "HIGH RISK — aggressive subtype" },
          { value: "basosquamous", label: "Basosquamous (metatypical)", description: "HIGH RISK — behaves like SCC" },
          { value: "pigmented", label: "Pigmented", description: "Usually nodular variant" },
          { value: "mixed", label: "Mixed subtype" },
        ],
      },
      {
        name: "Anatomical Location",
        description: "H-zone = central face, ears, eyelids, genitals (higher risk)",
        options: [
          { value: "h_zone", label: "H-zone (high risk)", description: "Central face, nose, periorbital, ears, lips, temples" },
          { value: "non_h_zone", label: "Non-H-zone", description: "Trunk, limbs, peripheral face" },
        ],
      },
      {
    ...
    stagingSystems: [
      {
        ...
        options: [
          { value: "well", label: "Well differentiated", description: "Lower risk" },
          { value: "moderate", label: "Moderately differentiated" },
          { value: "poor", label: "Poorly differentiated", description: "HIGH RISK" },
          { value: "undifferentiated", label: "Undifferentiated", description: "HIGH RISK" },
        ],
      },
      {
        name: "Anatomical Location",
        ...
        options: [
          { value: "h_zone", label: "H-zone (high risk)", description: "Central face, nose, periorbital, ears, lips" },
          { value: "non_h_zone", label: "Non-H-zone", description: "Trunk, limbs, scalp" },
        ],
      },
      {
      ...
      },
      {
        ...
        options: [
          ...
          { value: "small_nerve", label: "Present — small calibre nerve (<0.1mm)" },
          { value: "large_nerve", label: "Present — large calibre nerve (≥0.1mm)", description: "HIGH RISK — referral recommended" },
        ],
      },
    ],
  },
    ...
    stagingSystems: [
      {
        ...
        options: [
          { value: "≤2cm", label: "≤2 cm", description: "T1 — smaller primary" },
          { value: ">2cm", label: ">2 cm", description: "T2–T3 — larger primary" },
          { value: "bone_fascia", label: "Invading bone/fascia", description: "T4 — deep invasion" },
        ],
      },
      {
        name: "Lymph Node Status",
    ...
    stagingSystems: [
      {
        ...
        options: [
          { value: "mild", label: "Mild atypia", description: "Re-excision if incomplete — routine follow-up" },
          { value: "moderate", label: "Moderate atypia", description: "Re-excision recommended if margin involved" },
          { value: "severe", label: "Severe atypia", description: "Re-excision with clear margins — consider melanoma surveillance" },
        ],
      },
      {
        name: "Margin Status",
