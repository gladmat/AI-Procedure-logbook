/**
 * BreastProcedureList — Compact procedure summary for breast cases.
 *
...
interface BreastProcedureListProps {
...
export const BreastProcedureList = React.memo(function BreastProcedureList({
  procedures,
  onRemove,
  onMoveUp,
  onMoveDown,
}: BreastProcedureListProps) {
...
const BreastProcedureRow = React.memo(function BreastProcedureRow({
  procedure,
  index,
  total,
  onRemove,
