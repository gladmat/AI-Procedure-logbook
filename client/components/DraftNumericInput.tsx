/**
 * DraftNumericInput — Draft-preserving numeric text input.
 *
 * Allows mid-typing states like "0.", ".5", partial deletes without
 * parse-on-change rewriting the displayed value.
 * Sanitizes and commits on blur.
 *
 * Extracted from SkinCancerNumericInput (100% generic logic).
 */

import React, { forwardRef, useEffect, useState } from "react";
import { TextInput, type TextInputProps } from "react-native";

export interface DraftNumericInputProps
...
export function sanitizeNumericDraft(input: string, integer: boolean): string {
  let draft = "";
